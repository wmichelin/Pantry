...
ssh -T wmichelin@raspberrypi.local "echo \"$GITHUB_TOKEN\" | docker login ghcr.io -u wmichelin --password-stdin && cd ~/homelab && docker compose pull pantry && docker compose up -d pantry"
